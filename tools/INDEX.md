...
| [Devin (Devin CLI and Devin Desktop / Windsurf Cascade)](devin/GUIDE.md) | `devin` | `windsurf` `devin-cli` `devin-desktop` `cascade` `codeium` | json | user, project | beta | 2026-09-25 | [docs](https://docs.devin.ai/cli/extensibility/mcp/configuration) |
...
| [Kilo Code (extension and CLI)](kilo-code/GUIDE.md) | `kilo-code` | `kilo` `kilocode` | jsonc | user, project | stable | 2026-09-25 | [docs](https://kilo.ai/docs/automate/mcp/using-in-kilo-code) |
...
| [Qoder CLI](qoder/GUIDE.md) | `qoder` | `qodercli` | jsonc | user | beta | 2026-09-25 | [docs](https://docs.qoder.com/cli/mcp-servers) |
...
| [Visual Studio 2022/2026 (Windows)](visual-studio/GUIDE.md) | `visual-studio` | `vs` `visualstudio` | json | user, project | beta | 2026-09-25 | [docs](https://learn.microsoft.com/en-us/visualstudio/ide/mcp-servers) |
