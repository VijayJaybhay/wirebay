...
- Reads **opencode's global** config: deep-merges legacy opencode.json files from the same locations. ([source](https://kilo.ai/docs/getting-started/settings))
- Reads **opencode's project** config: deep-merges legacy opencode.json files from the same locations. ([source](https://kilo.ai/docs/getting-started/settings))
